          ...
          <div className="pt-6 sm:pt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-8 lg:gap-14 mb-8 items-center">
              ...
              <div className="flex flex-col items-center m-0 box-border w-full max-w-[280px] sm:max-w-[240px] h-auto sm:h-[230px]">
                <div className="font-bold text-sm sm:text-[0.95rem] text-primary border-2 border-primary rounded-t-[9px] bg-card py-[3px] box-border w-full text-center mb-0 font-oswald">
                  Software Development
                </div>
                <div className="bg-accent/20 rounded-b-[15px] px-[10px] pt-[10px] pb-[8px] shadow-card text-center w-full flex-1 flex flex-col justify-start">
                  <div className="text-foreground text-xs sm:text-[0.83rem] leading-[1.7] sm:leading-[1.9] font-nunito">
                    Web Development<br />
            ...
            <div className="mt-8">
              <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-7">
                ...
                <div className="flex-1 min-w-full lg:min-w-[320px] order-2 lg:order-1">
                  <h2 className="text-primary font-bold text-xl sm:text-[1.5rem] mb-4 font-oswald">
                    Special Programs
                  </h2>
                  <div className="text-foreground text-base sm:text-[1.08rem] leading-[1.6] sm:leading-[1.7] font-nunito">
